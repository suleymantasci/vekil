...
- Name: tests/e2e.spec.ts >> Vekil Application - Full Test Suite >> STAGE 10: API Health & Auth Functions >> 10.4 - Auth Me endpoint works with token
- Location: tests/e2e.spec.ts:425:9
